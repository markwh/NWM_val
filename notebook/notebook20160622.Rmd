...
Getting gage data since January 2012
...
Test using only two locations, one month of data. 
...
Huh, the first two gages are missing flow (but have stage). I wonder how many of them are like this?
...
Thes aggregate using the median observation for the hour (in case of freak outliers).
...
Good! Now put these into a munge script. 